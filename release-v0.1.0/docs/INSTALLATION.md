...
Goal: install the version 0.1.0 artifact intended for your host, verify that the host can discover it, and preserve a safe recovery path when the observed result differs.
...
- the correct version 0.1.0 artifact;
...
`release-v0.1.0/codex/lex-foster-language-companion/`
