...
Scope: source-verified public paths and runtime responsibilities for Lex Foster Language Companion version 0.1.0. Additional development or verification artifacts may exist; this page does not infer their purpose without inspection.
...
| `RELEASE-NOTES-v0.1.0.md` | Customer-facing release scope, impact, migration, and known limits |
...
| Path | Purpose |
|---|---|
| `release-v0.1.0/START-HERE.md` | Release-local customer journey and navigation |
| `release-v0.1.0/HOST-MATRIX.md` | Structural and live evidence by host |
| `release-v0.1.0/PROVENANCE.md` | Public identity, source custody, consulted foundations, and license boundary |
| `release-v0.1.0/codex/lex-foster-language-companion/` | Directly installable Codex skill folder |
| `release-v0.1.0/claude/lex-foster-language-companion-v0.1.0.zip` | One-skill Claude upload archive |
| `release-v0.1.0/maintainer-source/lex-foster-language-companion-v0.1.0/` | Versioned maintainer-source copy retained with the release |
| `release-v0.1.0/docs/` | Installation, operation, trust, recovery, reference, removal, and maintenance guidance |
