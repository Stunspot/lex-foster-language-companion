...
| GitHub Pages | `docs/` at repository root | Static HTML and link checks pending | Not deployed | Browser rendering, keyboard flow, screen-reader behavior, and production URL |
