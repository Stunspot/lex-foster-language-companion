...
Applicable version: version 0.1.1 until a later release explicitly supersedes it.
...
2. the canonical source under `source/` and the versioned customer release under `release-v0.1.1/`;
...
The current claim ledger is [Documentation source ledger](https://github.com/Stunspot/lex-foster-language-companion/blob/v0.1.1/verification/documentation-source-ledger.md).
...
| `RELEASE-NOTES-v0.1.1.md` | Understand customer-facing change | Versioned release scope, evidence, migration, and known limits |
| `release-v0.1.1/docs/` | Install, use, recover, inspect, and maintain | Versioned package and retained evidence |
...
- the intended reader can find the updated topic from [DOCUMENTATION.md](../PACKAGE-REFERENCE.md);
